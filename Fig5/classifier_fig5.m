...
%%
save('Fig5\classifier_toDay1_100iter.mat');
beep
%%
clear
load('ProcessedData\tables_compiled.mat');
...
day_pct = cell(1,length(tables_compiled));
% set to comparison day for cross-day testing
drop_table_stable = tables_compiled{5,1};
for i = 1:length(tables_compiled)
    day_pull = tables_compiled{i,1};
    day_pull_odors = day_pull.Odor;
    drop_table_deltas = day_pull.Deltas;
...
%%
save('Fig5\classifier_toDay5_100iter.mat');
beep
...
day_pct = cell(1,length(tables_compiled));
% set to comparison day for cross-day testing
drop_table_stable = tables_compiled{3,1};
for i = 1:length(tables_compiled)
    day_pull = tables_compiled{i,1};
    day_pull_odors = day_pull.Odor;
    drop_table_deltas = day_pull.Deltas;
...
%%
save('Fig5\classifier_toDay3_100iter.mat');
beep
...
day_pct = cell(1,length(tables_compiled));
% set to comparison day for cross-day testing
drop_table_stable = tables_compiled{2,1};
for i = 1:length(tables_compiled)
    day_pull = tables_compiled{i,1};
    day_pull_odors = day_pull.Odor;
    drop_table_deltas = day_pull.Deltas;
...
%%
save('Fig5\classifier_toDay2_100iter.mat');
beep
...
day_pct = cell(1,length(tables_compiled));
% set to comparison day for cross-day testing
drop_table_stable = tables_compiled{4,1};
for i = 1:length(tables_compiled)
    day_pull = tables_compiled{i,1};
    day_pull_odors = day_pull.Odor;
    drop_table_deltas = day_pull.Deltas;
...
%%
save('Fig5\classifier_toDay4_100iter.mat');
beep
