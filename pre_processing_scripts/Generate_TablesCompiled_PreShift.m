...
for k = 1:5
    ...
    responses_all = Pre_animal_odor_shifterByDay{1,k};
...
save('tables_compiled_preShift.mat','tables_compiled');
% save('animal_ID.mat','animal_ID');
% save('animal_Names_Responses.mat','used_ID');
% % use this one for consistency for responding values; not applicable for
% % behavior as more will be dropped due to lack of camera (NEC273332)
% save('trial_drop_logical.mat','dropper_final');
