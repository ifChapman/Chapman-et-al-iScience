...
trial_cutoff = 8; % number trials to keep for downs
...
save('ProcessedData\tables_compiled_behavior_retuned_021726.mat','tables_compiled', 'animal_ID', 'used_ID','dropper_final');
% saving extra info about which cells to keep for consistency with
% responder data later on
save('ProcessedData\animal_ID_behavior_retuned_021726.mat','animal_ID');
save('ProcessedData\used_ID_behavior_retuned_021726.mat','used_ID');
save('ProcessedData\trial_drop_logical_behavior_retuned_021726.mat','dropper_final');
