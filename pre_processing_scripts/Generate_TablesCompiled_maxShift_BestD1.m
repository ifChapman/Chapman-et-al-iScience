...
Odors_New = ["1","2","3","4","5","6"]; % new labels to avoid confusion later
...
for k = 1:5
    ...
    % responses_all = sorted_bestCorr_EveryDay{1,k};
    ...
    for i = 1:length(Odors_All)
        ...
        Odor = repmat(Odors_New(i),trial_cutoff,1);
...
save('tables_compiled_shifterMag_bestD1.mat','tables_compiled');
